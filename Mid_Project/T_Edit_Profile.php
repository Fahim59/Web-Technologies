...
$name = $mname = $fname = $email = $address = $pass = $cpass = $dd = $mm = $yyyy = $gender ="";
$ername = $ermname = $erfname = $eremail = $eradd = $erdob = $ergender = $erpass = $ercpass = "";
$error = $message = "";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"style="padding-top: 10px">
  <fieldset>
    <legend class="text"><b>TEACHER PROFILE EDIT</b></legend>
  <form>
    <br/>

    <center><input type="text" name="valueToSearch" placeholder="Enter Teacher ID">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        $data = file_get_contents("database/teacher/data.json");
