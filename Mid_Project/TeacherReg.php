...
if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      {
        if(file_exists('database/teacher/data.json'))
        {  
          $current_data = file_get_contents('database/teacher/data.json');  
          ...
          if(file_put_contents('database/teacher/data.json', $final_data))
          {
