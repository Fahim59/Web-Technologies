...
$name = $email = $address = $pass = $cpass = $dd = $mm = $yyyy = $gender ="";
$ername = $eremail = $eradd = $erdob = $ergender = $erpass = $ercpass = "";
$error = $message = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      {
        if(file_exists('database/librarian/data.json'))
        {  
          $current_data = file_get_contents('database/librarian/data.json');  
          ...
          if(file_put_contents('database/librarian/data.json', $final_data))
          {  
