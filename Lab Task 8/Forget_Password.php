...
<fieldset style="width: 1100px">
    ...
    <input class="input-field" value="<?php echo $email;?>" style="width: 500px" type="text" placeholder="Enter Your Email" name="email"><span class="error">  <?php echo $eremail;?> </span><br><div id="errorBox"></div><br>
