...
<link rel="stylesheet" href="header_footer/registration.css" crossorigin="anonymous">
  ...
  <script type="text/javascript">
    ...
    function submit()
    {
      document.getElementById("Teacher_Reg").reset();
    }
    function submit1()
    {
      ...
      var name = document.Teacher_Reg.name.value;
      var fname = document.Teacher_Reg.fname.value;
      var mname = document.Teacher_Reg.mname.value;
      var address = document.Teacher_Reg.address.value;
      var email = document.Teacher_Reg.email.value;
      var pass = document.Teacher_Reg.pass.value;
      var cpass = document.Teacher_Reg.cpass.value;
      var radiobutton = document.Teacher_Reg.radiobutton.value;
      var dob = document.Teacher_Reg.dob.value;
      var image = document.Teacher_Reg.image.value;

      //Name
      if(name == "")
      {
        document.Teacher_Reg.name.focus();
      ...
      if(fname == "")
      {
        document.Teacher_Reg.fname.focus();
      ...
      if(mname == "")
      {
        document.Teacher_Reg.mname.focus();
      ...
      if(email == "")
      {
        document.Teacher_Reg.email.focus();
      ...
      if(address == "")
      {
        document.Teacher_Reg.address.focus();
      ...
      if(pass == "")
      {
        document.Teacher_Reg.pass.focus();
      ...
      if(cpass == "")
      {
        document.Teacher_Reg.cpass.focus();
      ...
      if(image == "")
      {
        document.Teacher_Reg.image.focus();
        document.getElementById("errorBox").innerHTML = "Select Your Image";
        return false;
      }
      //Gender
      if(document.Teacher_Reg.radiobutton[0].checked == false && document.Teacher_Reg.radiobutton[1].checked == false && document.Teacher_Reg.radiobutton[2].checked == false)
      {
        document.Teacher_Reg.radiobutton.value;
      ...
      //Alert
      if(name != '' && mname  != '' && fname  != '' && pass  != '' && cpass != '' && email != '' && address != '' && image != '' && radiobutton != '' && dob != '')
      {
...
<form name="Teacher_Reg" method="post" action="controller/TeacherRegCheck.php"style="padding-top: 10px">
