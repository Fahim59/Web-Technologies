...
<header class="header">
	...
	<table >
		<tr>
			<th>
				<img src="image/icon.png" alt="school logo" width="80px" height="80px" >
			</th>
			...
			<?php if(isset($_SESSION["user_name"])) : ?>
				<span class="color">LOGGED IN AS</span> <a href="" style="width: 100%" ><?php echo $_SESSION["user_name"];?></a> |
				<a href="controller/logout.php" style="width: 100%" >LOG OUT</a> 
			<?php else : ?>
				<a href="PublicHome.php" style="width: 100%">Home</a> |
