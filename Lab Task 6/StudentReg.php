...
<form method="post" action="controller/StudentRegCheck.php"style="padding-top: 10px">
  ...
  <input required type="text" name="mname" value="<?php echo $mname;?>" ><span class="error"><?php echo "&nbsp&nbsp"?><?php echo $ermname;?> </span><br>
  <hr>

  <label for="fname" >Father Name<span class="error">* </label>
  <input required type="text" name="fname" value="<?php echo $fname;?>" ><span class="error"><?php echo "&nbsp&nbsp"?><?php echo $erfname;?> </span><br>
  <hr>
  ...
  <input required type="text" name="class" value="<?php echo $class;?>"><span class="error"><?php echo "&nbsp&nbsp"?><?php echo $erclass;?></span><br>
  <hr>
